...
# Map old->new
# old schema:
# 1 Modul, 2 Info, 3 Pflicht, 4 URL1,5 URL2,6 URL3,7 URL4,8 Zeitraum,9 DirektMessbar,10 Proxy,11 Bias,12 Korrektur,13 Prio,14 Bemerkung
for i, row in enumerate(old_rows, start=2):
    ...
    new_row = [
        ...
        pflicht,
        u1,
        direkt_global if u1 else "",
        "",
        u2,
        direkt_global if u2 else "",
        "",
        u3,
        direkt_global if u3 else "",
        "",
        u4,
        direkt_global if u4 else "",
        "",
        zeitraum,
        proxy,
        bias,
...
widths = {
    ...
    10: 28, 11: 18, 12: 20,
    13: 28, 14: 18, 15: 20,
    16: 18, 17: 34, 18: 26, 19: 28, 20: 16, 21: 24,
}
